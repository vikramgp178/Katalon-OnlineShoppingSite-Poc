...
WebUI.setText(findTestObject('Object Repository/Page_Account Information/input_First Name_firstname'), 'aaa')

WebUI.setText(findTestObject('Object Repository/Page_Account Information/input_Last Name_lastname'), 'shree')
