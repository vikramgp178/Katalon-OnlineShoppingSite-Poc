...
WebUI.setText(findTestObject('Object Repository/Page_Create New Customer Account/input_First Name_firstname'), 'Mukta')

WebUI.click(findTestObject('Object Repository/Page_Create New Customer Account/input_Last Name_lastname'))

WebUI.setText(findTestObject('Object Repository/Page_Create New Customer Account/input_Last Name_lastname'), 'shendge')

WebUI.setText(findTestObject('Object Repository/Page_Create New Customer Account/input_Email_email'), 'shreyasshendge96@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Create New Customer Account/input_Password_password'), 'p4y+y39Ir5Oy1MY8jPt0uQ==')
